...
export class UpdateComponent implements OnInit, OnDestroy {
  ...
  User: EmpDetails = {
    ...
    emp_name: '',
    emp_qual: '',
    emp_join_date: this.a[0],
    emp_resignation_date: this.a[0],
    emp_pan_no: '',
    emp_adhar_no: 0,
    emp_pf_flag: '',
    emp_pf_no: '',
  ...
  Read() {
    ...
    this.Subscription = this.Service.Read(this.User.emp_code).subscribe(
      (data: any) => {
        if (data) {
          console.log(data);
  ...
  Update() {
    ...
    this.Subscription = this.Service.Update(this.User.emp_code, this.User).subscribe(
